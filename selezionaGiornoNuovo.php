...
<!-- 
 si seleziona un giorno del mese e richiama un'altra pagina che visualizza le prenotazioni
 -->
...
<script type="text/javascript">
	window.onload = function(){		
		...
		//	document.getElementById("div3_example_result").innerHTML = obj.day + "/" + obj.month + "/" + obj.year;
			...
			window.location.href = 'visualizzaGiorno.php?Data='+ obj.day + "/" + obj.month + "/" + obj.year;
...
<body>
	...
	<div id="div3_example"
		style="margin: 10px 0 30px 0; border: dashed 1px red; width: 205px; height: 230px;">
